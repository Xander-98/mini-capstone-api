...
Product.create!([
  ...
  {name: "laptop", price: "950.0", description: "A good laptop for the price. Not the hardest hitting but there when you need it.", inventory: nil, sale: false, supplier_id: 3},
  {name: "Test", price: "40.9", description: "12345678111", inventory: nil, sale: false, supplier_id: 3},
  {name: "couch", price: "250.0", description: "You'll never want to leave the couch again after buying this super comfortable sectional", inventory: nil, sale: false, supplier_id: 3},
  {name: "yoga ball", price: "20.0", description: "So you started to get back into yoga, you're gonna need one of these eventually, so just buy it", inventory: nil, sale: false, supplier_id: 3},
